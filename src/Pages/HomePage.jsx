...
function HomePage() {
  const sampleCards = [
    ...
    ["Use the sectioning elements to create a broad outline for your page content, including...", "html"],
    ...
    ["Cross-site HTTP requests are HTTP requests for resources from a different domain than the...", "css"],
    ...
    ["HTML (HyperText Markup Language) is the most basic building block of the Web. It defines... ", "react"],
    ["JavaScript (JS) is a lightweight interpreted (or just-in-time compiled) programming language...", "sass"],
    ["React is a library for building user interfaces. React is not a framework – it's not...", "reactrouter"],
    ["The DOM Node interface is an abstract base class upon which many other DOM API objects... ", "javascript"],
    ["The DOM (Document Object Model) is an API that represents and interacts with any HTML...", "tailwindcss"],
    ["The Array object enables storing a collection of multiple items under a single variable...", "nodejs"],
    ["The Object type represents one of JavaScript's data types. It is used to store various...", "redux"],
    ["The Function object provides methods for functions. In JavaScript, every function is actually...", "reactrouter"],
    ["The Number constructor contains constants and methods for working with numbers. Values of other...", "nodejs"],
    ["Symbol is a built-in object whose constructor returns a symbol primitive — also called a Symbol... ", "nodejs"],
    ["An HTTP Range request asks the server to send only a portion of an HTTP message back to a client...", "css"],
    ["The class global attribute is a list of the classes of the element, separated by ASCII whitespace...", "html"],
    ["JavaScript Object Notation (JSON) is a standard text-based format for representing structured data... ", "javascript"],
    ["Flexbox is a one-dimensional layout method for arranging items in rows or columns. Items flex (expand)... ", "redux"],
    ...
    ["Main represents the dominant content of the body of a document. The main content area consists...", "html"],
    ["Hypertext Transfer Protocol (HTTP) is an application-layer protocol for transmitting...", "webbasic"],
    ["Cross-site HTTP requests are HTTP requests for resources from a different domain than the...", "html"],
    ["The HTTP cache stores a response associated with a request and reuses the stored response...", "webbasic"],
    ["A cookie (also known as a web cookie or browser cookie) is a small piece of data a server... ", "react"],
    ["The Function object provides methods for functions. In JavaScript, every function is actually...", "reactrouter"],
    ["The Number constructor contains constants and methods for working with numbers. Values of other...", "nodejs"],
    ["Symbol is a built-in object whose constructor returns a symbol primitive — also called a Symbol... ", "html"],
    ["An HTTP Range request asks the server to send only a portion of an HTTP message back to a client...", "sass"],
    ["The class global attribute is a list of the classes of the element, separated by ASCII whitespace...", "html"],
    ["JavaScript Object Notation (JSON) is a standard text-based format for representing structured data... ", "react"],
    ...
    ["React is a library for building user interfaces. React is not a framework – it's not...", "reactrouter"],
    ["The DOM Node interface is an abstract base class upon which many other DOM API objects... ", "nodejs"],
    ["The DOM (Document Object Model) is an API that represents and interacts with any HTML...", "html"],
    ["The Array object enables storing a collection of multiple items under a single variable...", "css"],
    ["The Object type represents one of JavaScript's data types. It is used to store various...", "react"]
  ];
